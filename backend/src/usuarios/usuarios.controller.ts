...
export class UsuariosController {
  ...
  create(@Body() dto: CreateUsuarioDto, @CurrentUser() ator: JwtPayload): Promise<UsuarioResponseDto> {
    return this.usuariosService.create(dto, ator.sub);
  }
  ...
  update(
    ...
    @CurrentUser() ator: JwtPayload,
  ): Promise<UsuarioResponseDto> {
    return this.usuariosService.update(id, dto, ator.sub);
  }
  ...
  resetarSenha(
    ...
    return this.usuariosService.resetarSenha(id, dto, ator.sub);
  }
}
